...
- Stub services intentionally do nothing but log and idle (or, for `db-indexing-sidecar`, actually create indexes and exit 0 - that one's stub *is* its real job). Real ingestion/enrichment/API logic is round-2 work per service.
